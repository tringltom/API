...
namespace Persistence.Migrations
{
    ...
    [Migration("20220530221006_ChallengeAnswers")]
    partial class ChallengeAnswers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ChallengeMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("UserChallengeAnswerId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserChallengeAnswerId");

                    b.ToTable("ChallengeMedias");
                });
            ...
            modelBuilder.Entity("Domain.UserAttendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.UserChallengeAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.UserPuzzleAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.ChallengeMedia", b =>
                {
                    b.HasOne("Domain.UserChallengeAnswer", "UserChallengeAnswer")
                        .WithMany("ChallengeMedias")
                        .HasForeignKey("UserChallengeAnswerId");
                });
